...
**Source:** [`@cave/tui`](https://github.com/badlogic/pi-mono/tree/main/packages/tui)
...
```typescript
import { CURSOR_MARKER, type Component, type Focusable } from "@cave/tui";
...
```typescript
import { Container, type Focusable, Input } from "@cave/tui";
...
Import from `@cave/tui`:

```typescript
import { Text, Box, Container, Spacer, Markdown } from "@cave/tui";
```
...
```typescript
import { matchesKey, Key } from "@cave/tui";
...
```typescript
import { visibleWidth, truncateToWidth } from "@cave/tui";
...
```typescript
import { getMarkdownTheme } from "cave";
import { Markdown } from "@cave/tui";
...
For letting users pick from a list of options. Use `SelectList` from `@cave/tui` with `DynamicBorder` for framing.

```typescript
import type { ExtensionAPI } from "cave";
import { DynamicBorder } from "cave";
import { Container, type SelectItem, SelectList, Text } from "@cave/tui";
...
For toggling multiple settings. Use `SettingsList` from `@cave/tui` with `getSettingsListTheme()`.

```typescript
import { getSettingsListTheme } from "cave";
import { Container, type SettingItem, SettingsList, Text } from "@cave/tui";
...
import { matchesKey, truncateToWidth } from "@cave/tui";
